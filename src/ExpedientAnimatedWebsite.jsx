            ...
            <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
              ...
              <div className="flex justify-center">
                <figure className="w-full max-w-[760px] overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl">
                  <div className="flex min-h-[320px] w-full items-center justify-center bg-slate-50 p-8 text-center">
                    <div className="max-w-md">
                      ...
                      <p className="mt-4 text-lg font-semibold text-slate-900">3P framework image area</p>
                      <p className="mt-2 text-sm leading-7 text-slate-600">
                        The live website should use your approved 3P framework image file here. The canvas preview cannot reliably render the current local image path, so this placeholder keeps the rest of the page visible and stable.
                      </p>
                    </div>
                  </div>
                </figure>
          ...
          >
            <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              ...
              <div className="rounded-[1.5rem] border border-white/10 bg-slate-950/40 p-6">
                ...
                <button
                  type="button"
                  className="mt-6 inline-flex items-center justify-center rounded-xl bg-emerald-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:-translate-y-0.5"
                >
                  Register here
                </button>
              </div>
          ...
          >
            ...
            <form className="mt-8 grid gap-4">
              ...
              <div>
                ...
                <select className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none">
